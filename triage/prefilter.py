...
_SCREEN_SYSTEM = (
    ...
    "engineering, agentic tooling). He sells credibly into AWS-keyworded roles. He is open to BOTH "
    "remote AND onsite roles anywhere in the US — he will relocate for the right role — contract "
    "preferred but a strong perm counts.\n\n"
    ...
    "application building, a non-engineering role, or a "
    "junior/intern posting. Do NOT reject on location — onsite/relocation is fine.\n\n"
